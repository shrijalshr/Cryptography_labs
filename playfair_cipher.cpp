...
int main()
{
	int i, j, k, numstr[100], numcipher[100], numkey[100], lenkey, templen, tempkey[100],
	...
	std::cout << "Entered key converted according to Play Fair Cipher rule\n";
	...
	std::cout << "Arranged key\n";

	for (i = 0; i < 5; i++) {
		for (j = 0; j < 5; j++) {
			std::cout << cipherkey[i][j] + 'A';
		}
		std::cout << std::endl;
	}
	...
	std::cout << "Entered String/Message After Processing according to Play fair cipher rule\n";
